"""
IMGPHILE - Scrapper Bot
Author : Anas Shakeel
version : 3.0

### Short Description:
This is a simple scrapper bot written completely in python by Anas Shakeel.
It allows its users (currently only me!) to download every image (original quality) from
`imgpile.com` website to local storage.
